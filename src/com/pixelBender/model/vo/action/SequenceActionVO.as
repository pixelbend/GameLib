package com.pixelBender.model.vo.action
{
	...
	public class SequenceActionVO extends ActionVO
	{
		//==============================================================================================================
		// STATIC MEMBERS
		//==============================================================================================================

		public static const	NAME										:String = "SequenceActionVO";
		...
		{
			initializeBaseAction(GameConstants.ACTION_TYPE_SEQUENTIAL, ID);
