package com.pixelBender.controller.fileReference
{
	...
	public class RemoveFileReferenceContentCommand extends SimpleCommand
	{
		//==============================================================================================================
		// EXECUTE
		//==============================================================================================================
		...
		/**
		 * Removes the file reference content identified by the notification VO parameters
		...
		override public function execute(notification:INotification):void
		{
			...
			// Execute
			fileReferenceProxy.removeFileReferenceContent(note.getGroupName(), note.getFileName());
		}
	}
}
